    ...
    <footer className="py-12 bg-black border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-white">
           ...
           <a href="https://t.me/EdXploit" target="_blank" rel="noopener noreferrer" className="hover:text-brand transition-colors transform hover:scale-110" aria-label="Telegram"><Send size={24} /></a>
           <a href="https://vt.tiktok.com/ZS5vb2AxU/" target="_blank" rel="noopener noreferrer" className="hover:text-brand transition-colors transform hover:scale-110" aria-label="TikTok">
              <svg

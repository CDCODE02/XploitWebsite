        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            <div className="relative z-10 grid grid-cols-2 gap-6">
               <img 
                 src="https://i.ibb.co/Q3X4jRQ2/heroimg.jpg" 
                 alt="Working" 
                 className="rounded-2xl border border-white/5 object-cover w-full shadow-2xl h-64 md:h-[480px] translate-y-8 md:translate-y-16" 
               />
               <img 
                 src="https://i.ibb.co/hxpgGv6d/about.jpg" 
                 alt="Speaking" 
                 className="rounded-2xl border border-white/5 object-cover w-full shadow-2xl h-64 md:h-[480px]" 
               />
            </div>
            {/* Background decoration */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[130%] h-[130%] border border-white/5 rounded-full opacity-20" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] h-[90%] border border-brand/20 rounded-full opacity-20 animate-spin-slow" style={{ animationDuration: '20s' }} />
          </motion.div>
        </div>
      </div>
    </section>
